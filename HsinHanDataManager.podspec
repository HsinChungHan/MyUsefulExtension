#
#  Be sure to run `pod spec lint HsinHanDataManager.podspec' to ensure this is a
...
It's an useful extension library.
  ...
  s.author             = { "HsinChungHan" => "hooy123456@gapp.nthu.edu.tw" }
  # Or just: s.author    = "HsinChungHan"
  # s.authors            = { "HsinChungHan" => "hooy123456@gapp.nthu.edu.tw" }
  # s.social_media_url   = "http://twitter.com/HsinChungHan"
